  ...
  <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-4 flex flex-col h-[500px]">
    ...
    <template v-else>
      ...
      <div class="relative rounded-xl overflow-hidden flex-1 mb-3 bg-slate-200 min-h-0">
        <img :src="main.imageUrl" :alt="`CCTV ${main.name}`" class="w-full h-full object-cover image-grayscale" />
      ...
      <div class="space-y-2 flex-shrink-0">
        ...
        >
          <img :src="c.imageUrl" class="w-full h-full object-cover image-grayscale" :alt="c.name" />
